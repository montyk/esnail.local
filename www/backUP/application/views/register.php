	...
	<table id="register-table">
		...
		<tr>
			<td colspan="2" class="subsectionTitle">
				...
				I would like to register a Business name as a mail recipient at eSnail.ca
			</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	check = {
		...
		template: function(fieldId, status) {
			...
			if (status == 1) {
				checkCell.html('<img src="/img/icons/tick.png">');
				checkCell.attr('status', 1);
			} else {
				checkCell.html('<img src="/img/icons/exclamation.png">');
