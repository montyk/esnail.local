<?php
$env = 'dev';
	if($env=='dev'){ $base = '/SANDBOX/'; }
		else if($env=='prod') { $base = '/SANDBOX/'; }
?>
...
<div class="header">
	<div class="wrapper">
        ...
        <div id="menu">
        	<ul>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'how-it-works')) { echo 'class="active-link"'; } ?>><a href="<?=$base;?>how.php">How it works</a></li>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'plans')) { echo 'class="active-link"'; } ?>><a href="<?=$base;?>plans.php">Plans</a></li>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'support')) { echo 'class="active-link"'; } ?>><a href="<?=$base;?>support.php">Support</a></li>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'virtual-po-box')) { echo 'class="active-link"'; } ?>><a href="<?=$base;?>virtual-po-box.php">Virtual PO Box</a></li>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'security')) { echo 'class="active-link"'; } ?>><a href="<?=$base;?>security.php">Security</a></li>
            	<li <?php if(strpos($_SERVER['SCRIPT_NAME'], 'about')) { echo 'class="active-link"'; } ?> class="last-child"><a href="<?=$base;?>about.php">About us</a></li>                                                                               
            </ul>
        </div>
        <div class="clear"></div>
