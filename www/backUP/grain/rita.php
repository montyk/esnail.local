...
define('__UNIQUE_HASH__', 'f1b06179a6f3a554960431fe5ab1e241');
...
function UpdatePath(& $rsCurrentScriptContent, & $rsNewScriptContent) 
{
	...
	{
		$rsNewScriptContent = str_replace('\'index.html\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
	
	$nMatchResult = preg_match('#define\\(\'__UNIQUE_HASH__\', (\'.*\')\\);#i', $rsCurrentScriptContent, $lssScriptPathMatch);
	if(!($nMatchResult === false) && $nMatchResult > 0) 
	{
		$rsNewScriptContent = str_replace('\'f1b06179a6f3a554960431fe5ab1e241\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
}
