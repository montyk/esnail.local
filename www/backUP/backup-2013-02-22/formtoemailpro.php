...
$privatekey = "6Le0UgoAAAAAADt-USY03EYJJaDOuPjPYzWzBP_5";
...
$subject = "New eSnail Registration";
...
$form_page_url = "RegisterPage1.php";
...
$required_fields = array('Ihavereadtheterms','firstname','lastname','email','email2','username','password','password2','Ihavereadtheterms');
...
if($_REQUEST['password'] != $_REQUEST['password2']){$errors[] = "Please correctly confirm your password";}else{unset($_REQUEST['password2']);}
...
<br>You have been sucessfully registered with eSnail.ca.  You may now direct your mailers to send your mail to the following address:
<table cellpadding="0" cellspacing="50">
<tr>
	<td valign="top">
    <p><?php if(isset($_REQUEST['firstname'])){print stripslashes($_REQUEST['firstname']);} ?>&nbsp;<?php if(isset($_REQUEST['lastname'])){print stripslashes($_REQUEST['lastname']);} ?>
    <p>19019-2302 West 4th Ave.</p>
    <p>Vancouver, BC</p>
    <p>V6K 1R8</p>
    </td>
    <td><p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
<p> You can visit the FAQ portion of the site for news on our latest PO Box locations.&nbsp; Please proceed to the secure payment area.
